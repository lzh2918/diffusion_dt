...
class Trainer(object):
    ...
    def train(self, n_train_steps):
        ...
        for step in range(n_train_steps):
            for i in range(self.gradient_accumulate_every):
                ...
                batch = batch_to_device(batch, device=self.device) # 格式为 32, 100, 14，轨迹长度变成了100
    ...
    def render_reference(self, batch_size=10):
        ...
        action_reward_dim = self.dataset.action_dim + 1
        normed_observations = trajectories[:, :, action_reward_dim:]
    ...
    def render_samples(self, batch_size=2, n_samples=2):
        ...
        #     action_reward_dim = self.dataset.action_dim + 1
        #     normed_observations = samples[:, :, action_reward_dim:]
