...
class ResidualTemporalBlock(nn.Module):
    ...
    def __init__(self, inp_channels, out_channels, embed_dim, horizon, kernel_size=5, mish=True):
        ...
        self.blocks = nn.ModuleList([
            Conv1dBlock(inp_channels, out_channels, kernel_size, mish), # in_channel 11, out_channel 128 这样的话应该是比较合理的。
    ...
    def forward(self, x, t):
        ...
        '''
        out = self.blocks[0](x) + self.time_mlp(t) # x 1,11,100  t 1,256  out 1, 128,100怎么做到的呢？之后看一下。
...
class TemporalUnet(nn.Module):
    ...
    def __init__(
        ...
        # in_out [(11, 128), (128, 512), (512, 1024)] 好像根本没提horizon的事。那应该是这样的。
