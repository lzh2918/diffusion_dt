...
class EDMDiffusion(nn.Module):
    ...
    def sample_sigma_training(self, batch_size, device):
        ...
        return s.exp().clip(self.edm_cfg.sigma_min, self.edm_cfg.sigma_max_sampler)
    ...
    def denoise_forward(self, noisy_x, sigma, cond_traj, returns):
        ...
        model_output = self.inner_model(rescale_noise, c_noise, returns)
    ...
    def sample(self, cond, returns=None, horizon=None, *args, **kwargs):
        ...
        predict_seq_len = horizon - cond_length
        ...
        for sigma, next_sigma in zip(self.sigmas[:-1], self.sigma[1:]):
            ...
            _, denoised = self.denoise_forward(x, sigma, cond, returns) # 归一化有没有复原？
